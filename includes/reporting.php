...
function report_screen_definitions(){
    ...
    return [
        ...
        'alarmas24h'=>['label'=>'Instalaciones · Alarmas 24h','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=alarmas24h&scope=instalaciones'],
        'instalaciones_alarmas_semanal'=>['label'=>'Instalaciones · Alarmas semanal','group'=>'Alarmas Instalaciones de superficie','target'=>'instalaciones_alarmas_semanal.php'],
        'alarmas_activas'=>['label'=>'Instalaciones · Alarmas por Históricos','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=alarmas_activas&scope=instalaciones'],
        'pi_historico'=>['label'=>'Instalaciones · PI Histórico','group'=>'Alarmas Instalaciones de superficie','target'=>'pi_historico.php'],
        'suprimidas'=>['label'=>'Instalaciones · Suprimidas','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=suprimidas&scope=instalaciones'],
        'reconocidas'=>['label'=>'Instalaciones · Reconocidas','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=reconocidas&scope=instalaciones'],
        'reconocidas_usr'=>['label'=>'Instalaciones · Reconocidas por usuario','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=reconocidas_usr'],
        'top20_all'=>['label'=>'Instalaciones · Top 20 alarmas','group'=>'Alarmas Instalaciones de superficie','target'=>'instalaciones_top20.php'],
        'top20_24h'=>['label'=>'Instalaciones · Top 20 alarmas 24h','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=top20_24h&scope=instalaciones'],
        'ranking24h'=>['label'=>'Instalaciones · Ranking 24h','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=ranking24h'],
        'tendencia_sem'=>['label'=>'Instalaciones · Tendencia semanal','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=tendencia_sem'],
        'tend_sem_tags'=>['label'=>'Instalaciones · Tendencia por TAG','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=tend_sem_tags'],
        'prioridad'=>['label'=>'Instalaciones · Prioridad','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=prioridad'],
        'todas_alarmas'=>['label'=>'Instalaciones · Todas las alarmas','group'=>'Alarmas Instalaciones de superficie','target'=>'todas_alarmas.php'],
        'analisis_ia'=>['label'=>'Instalaciones · Análisis IA','group'=>'Alarmas Instalaciones de superficie','target'=>'analisis_ia.php'],
        'importadas'=>['label'=>'Instalaciones · Alarmas importadas','group'=>'Alarmas Instalaciones de superficie','target'=>'list.php?s=importadas'],
