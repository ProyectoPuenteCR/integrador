...
BEGIN
    ...
    SELECT DISTINCT UPPER(LTRIM(RTRIM(TAG))) COLLATE DATABASE_DEFAULT AS TAG_NORM
    INTO #POZO_TAGS
    FROM #BASE7
    ...
    INSERT #S VALUES(N'KPI',102,N'INST_TAGS_UNICOS24H',NULL,(SELECT COUNT_BIG(DISTINCT NULLIF(TAG,N'')) FROM #BASE24_INST),NULL,NULL,NULL,@ahora);
    ...
    INSERT #S
    SELECT N'INSTALACIONES',ORDEN,INSTALACION,NULL,TOTAL,CRITICAS,NULL,NULL,@ahora
        ...
        WHERE
            ...
            OR METRICA IN
                (N'TOP_ALARMAS_INST',N'TENDENCIA_INST',N'PRIORIDAD_INST',
                 N'HORARIA_INST',N'FLUJO_INST',N'HEATMAP_INST',N'OPERADORES_INST',N'INSTALACIONES');
