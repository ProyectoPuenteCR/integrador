  ...
  <main class="main">
    ...
    <?php else: ?>
      <form class="it20Toolbar" method="get" action="instalaciones_top20.php" id="instalacionesTop20Filters" data-current-week="<?php echo h($currentWeekStart); ?>" data-selected-week="<?php echo h($fromDate); ?>">
        ...
        <label class="it20Select"><?php echo icon('map'); ?><span>Instalación</span><select name="instalacion" aria-label="Filtrar por instalación"><option value="">Todas</option><?php foreach ($installations as $installationValue): ?><option value="<?php echo h($installationValue); ?>" <?php echo $installationFilter === $installationValue ? 'selected' : ''; ?>><?php echo h($installationValue); ?></option><?php endforeach; ?><?php if ($installationFilter !== '' && !in_array($installationFilter, $installations, true)): ?><option value="<?php echo h($installationFilter); ?>" selected><?php echo h($installationFilter); ?></option><?php endif; ?></select></label>
